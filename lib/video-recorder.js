...
})(['max-width:100%;max-height:100%;padding-top:48px;padding-bottom:75px;', ' ', ' ', ';@media (min-width:768px){', ';}'], function (props) {
  return props.isReplayingVideo && 'padding-top: 50px;';
}, function (props) {
  return props.isReplayingVideo && 'padding-bottom: 179px;';
}, function (props) {
  return props.onClick && 'cursor: pointer;';
}, function (props) {
  return props.isReplayingVideo && 'padding-bottom: 94px;';
});
  ...
  _createClass(VideoRecorder, [{
    ...
    value: function renderCameraView() {
      ...
      var _props = this.props,
          ...
          browserErrorMessage = _props.browserErrorMessage;
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          finishButton = _props2.finishButton,
          finishWarningMessage = _props2.finishWarningMessage,
          recordAnotherVideoLabel = _props2.recordAnotherVideoLabel;
      ...
      return _react2.default.createElement(
        ...
        this.props.renderActions({
          ...
          finishWarningMessage: finishWarningMessage,
          recordAnotherVideoLabel: recordAnotherVideoLabel,
...
VideoRecorder.defaultProps = {
  ...
  renderErrorView: function renderErrorView(browserErrorMessage) {
    return _react2.default.createElement(_errorView2.default, { browserErrorMessage: browserErrorMessage });
  },
  ...
  renderLoadingView: function renderLoadingView(loadingMessage) {
    return _react2.default.createElement(_loadingView2.default, { label: loadingMessage });
  },
  ...
  browserErrorMessage: 'Oh snap! Your browser failed to record your video. \n\n\n Please restart it and try again 👍'
};