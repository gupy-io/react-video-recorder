...
})(['position:absolute;bottom:0;left:0;right:0;display:', ';align-items:center;justify-content:center;padding:17px;background-color:#000;width:100%;'], function (props) {
...
exports.default = function (_ref) {
  ...
  var renderContent = function renderContent() {
    ...
    if (isReplayingVideo) {
      return _react2.default.createElement(_recordAnotherVideoButton2.default, {
